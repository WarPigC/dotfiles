...
-- Hyprland 0.55+ config format. Refer to the wiki for more information:
-- https://wiki.hypr.land/Configuring/Start/
-- #######################################################################################
--
-- NOTE: your old config sourced a separate file:
--     source = ~/.config/hypr/monitors.conf
-- Lua configs use `require()` instead of `source`. That file has been converted
-- too — see monitors.lua (place it alongside this file as
...
hl.on("hyprland.start", function()
    hl.exec_cmd("waybar && pkill waybar && waybar")
...
hl.config({
    general = {
        ...
        col = {
            active_border = "rgba(E5383Baa)",
            inactive_border = "rgba(80797aaa)",
        },
...
hl.curve("ultraSmooth",     { type = "bezier", points = { {0.16, 1},    {0.3, 1}    } })
...
hl.animation({ leaf = "workspaces",    enabled = true, speed = 4,    bezier = "ultraSmooth",   style = "slidefade 10%" })
...
-- Screenshot a region
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -z --clipboard-only -m region"))
